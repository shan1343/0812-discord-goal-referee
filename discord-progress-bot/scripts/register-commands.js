...
const commands = [
  new SlashCommandBuilder().setName("progress").setDescription("이 채널의 대화를 분석해 프로젝트 진행률을 표시합니다.").toJSON(),
  new SlashCommandBuilder().setName("roles").setDescription("이 채널의 대화로 역할 분담 제안을 표시합니다.").toJSON()
];
